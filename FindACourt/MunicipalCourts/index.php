    ...
    $(document).ready(function(){
        ...
        function displayAllCourts(tempData) {
            ...
            .then((data) => {
                ...
                p.innerHTML = "Municipal Court judges hear matters involving violations of city ordinance, non-traffic misdemeanors, traffic violations, and in some cities, parking violations. A limited-jurisdiction court of law, the 30 Judges at the 17 Municipal Courts also hear civil matters (for instance, when they apply to collecting unpaid utility bills).";
